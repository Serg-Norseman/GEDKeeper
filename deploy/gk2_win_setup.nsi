...
LangString gkreq ${LANG_GERMAN} "GEDKeeper2 (required)"
LangString gkscr ${LANG_GERMAN} "Script samples"
LangString gkreg ${LANG_GERMAN} "System registration"
LangString gklang ${LANG_GERMAN} "Languages"
LangString gkplg ${LANG_GERMAN} "Plugins"
LangString gkp_calc ${LANG_GERMAN} "Expression calculator"
LangString gkp_calendar ${LANG_GERMAN} "Calendar"
LangString gkp_nb ${LANG_GERMAN} "Names book"
LangString gkp_timeline ${LANG_GERMAN} "Time line"
LangString gkp_flowinput ${LANG_GERMAN} "Flow input"
LangString gkp_pi ${LANG_GERMAN} "Pedigrees importer"
LangString gkp_ts ${LANG_GERMAN} "Text search"
LangString gkp_tv ${LANG_GERMAN} "3D TreeViz"
LangString gkp_iv ${LANG_GERMAN} "Image viewer"
LangString gkp_cl ${LANG_GERMAN} "Conway Life"
LangString gkp_chron ${LANG_GERMAN} "Chronicle"
