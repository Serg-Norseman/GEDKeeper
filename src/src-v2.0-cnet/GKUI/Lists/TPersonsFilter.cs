...
namespace GKUI.Lists
{
	public class TPersonsFilter : TFilter
	{
		...
		internal string Back_AliveBeforeDate;
		internal TFilter.TGroupMode Back_GroupMode;
		internal string Back_GroupRef;
		internal TGenEngine.TLifeMode Back_LifeMode;
		internal string Back_Name;
		internal bool Back_PatriarchOnly;
		internal string Back_Residence;
		internal TGEDCOMObject.TGEDCOMSex Back_Sex;
		internal TFilter.TGroupMode Back_SourceMode;
		internal string Back_SourceRef;
		internal string Back_EventVal;
		...
		public void Clear()
		{
			...
			this.Residence = "*";
			this.Sex = TGEDCOMObject.TGEDCOMSex.svNone;
