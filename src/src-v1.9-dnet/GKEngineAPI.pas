...
uses
  System.Windows.Forms, VCLStub, GKBase;

type
  TScriptEngine = class
    procedure lua_run(script: string; aBase: TfmBase; aDebugOutput: System.Windows.Forms.TextBox);
  end;
...
begin
  ...
  sx := TfmSexCheck.DefineSex(name, patr, fmGEDKeeper.NamesTable);
...
procedure TScriptEngine.lua_run(script: string; aBase: TfmBase; aDebugOutput: System.Windows.Forms.TextBox);
{$IFNDEF DELPHI_NET}
var
  L: Plua_State;
  res: Integer;
