...
type
  ...
  private
    FPersonXRef: string;
    FOldSex, FNewSex: TGEDCOMSex;
  public
    constructor Create(aManager: TUndoManager; aPerson: TGEDCOMIndividualRecord; NewSex: TGEDCOMSex); reintroduce;
...
constructor TCmdPersonChangeSex.Create(aManager: TUndoManager;
  aPerson: TGEDCOMIndividualRecord; NewSex: TGEDCOMSex);
begin
