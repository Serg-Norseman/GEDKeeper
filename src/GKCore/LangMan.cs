...
namespace GKCore
{
	...
	public enum LSID : ushort
	{
		...
		/* 607 */ LSID_BackColor,
		/* 608 */ LSID_LinesColor,
		/* 609 */ LSID_ShowCircLines,
		/* 610 */ LSID_SearchIndexRefreshing,
		/* 611 */ LSID_FullTextSearch,
		/* 612 */ LSID_SearchResults,
		/* 613 */ LSID_LogSend,
		/* 614 */ LSID_Charts,
	...
	public static class LangMan
	{
		...
		private static readonly string[] LSDefList = new string[]
		{
			...
			/* 044 */ "&Свернуть все",
			/* 045 */ "&Разместить все",
			/* 046 */ "Ресурсы в Интернете...",
			/* 047 */ "Терминология родства...",
			/* 048 */ "Часто задаваемые вопросы...",
			/* 049 */ "Содержание",
			/* 050 */ "О программе",
			/* 051 */ "Записей",
			/* 052 */ "фильтрованных",
			...
			/* 607 */ "Цвет фона",
			/* 608 */ "Цвет линий",
			/* 609 */ "Отображать контуры кругов",
			/* 610 */ "Обновление поискового индекса",
