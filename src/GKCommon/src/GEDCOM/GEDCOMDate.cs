...
namespace GKCommon.GEDCOM
{
    ...
    public class GEDCOMDate : GEDCOMCustomDate
	{
		...
		{
			string result;
			if (this.fDateFormat == GEDCOMDateFormat.dfSystem)
			{
		...
		private static string CheckGEDCOMMonth(string S)
		{
			...
			{
				if (GEDCOMCustomDate.GEDCOMMonthArray[month - 1] == SU)
				{
					return GEDCOMCustomDate.GEDCOMMonthArray[month - 1];
				}
			}
		...
		private static string CheckGEDCOMMonthFrench(string S)
		{
			...
			{
				if (GEDCOMCustomDate.GEDCOMMonthFrenchArray[month - 1] == SU)
				{
					return GEDCOMCustomDate.GEDCOMMonthFrenchArray[month - 1];
				}
			}
		...
		private static string CheckGEDCOMMonthHebrew(string S)
		{
			...
			for (int month = 1; month <= 13; month++)
			{
				if (GEDCOMCustomDate.GEDCOMMonthHebrewArray[month - 1] == SU)
				{
					return GEDCOMCustomDate.GEDCOMMonthHebrewArray[month - 1];
				}
			}
		...
		{
            return GEDCOMCustomDate.GEDCOMMonthArray[(int)m - 1];
		}

		private static string IntToGEDCOMMonthFrench(ushort m)
		{
            return GEDCOMCustomDate.GEDCOMMonthFrenchArray[(int)m - 1];
		}

		private static string IntToGEDCOMMonthHebrew(ushort m)
		{
            return GEDCOMCustomDate.GEDCOMMonthHebrewArray[(int)m - 1];
		}
		...
		private static ushort GEDCOMMonthFrenchToInt(string S)
		{
			...
			if (S != null)
			{
				...
				{
					if (GEDCOMCustomDate.GEDCOMMonthFrenchArray[(int)M - 1] == SU)
					{
						result = M;
						break;
					}
		...
		private static ushort GEDCOMMonthHebrewToInt(string S)
		{
			...
			if (S != null)
			{
				...
				for (ushort M = 1; M <= 13; M++)
				{
					if (GEDCOMCustomDate.GEDCOMMonthHebrewArray[(int)M - 1] == SU)
					{
						result = M;
						break;
					}
