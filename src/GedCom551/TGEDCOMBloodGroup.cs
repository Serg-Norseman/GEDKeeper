...
namespace GedCom551
{
	public sealed class TGEDCOMBloodGroup : TGEDCOMIndividualAttribute
	{
		...
		{
			get {
				return this.fBloodGroup;
			}
			set {
				this.fBloodGroup = value;
			}
		}
		...
		public TGEDCOMBloodGroup(TGEDCOMTree owner, TGEDCOMObject parent, string tagName, string tagValue) : base(owner, parent, tagName, tagValue)
		{
		}
