...
namespace GedCom551
{
	public static class GEDCOMUtils
	{
		...
		public static string ExtractString(string S, out string AString, string ADefault)
		{
			string result = S;
		...
		public static string ExtractXRef(string S, out string AXRef, bool NoException, string ADefault)
		{
			string result = S;
		...
		public static TGEDCOMRestriction GetRestrictionVal(string S)
		{
		...
		public static string GetRestrictionStr(TGEDCOMRestriction val)
		{
			string S;
			switch (val) {
		...
		public static TGEDCOMPedigreeLinkageType GetPedigreeLinkageTypeVal(string S)
		{
		...
		public static string GetPedigreeLinkageTypeStr(TGEDCOMPedigreeLinkageType val)
		{
			string S;
			switch (val) {
		...
		public static TGEDCOMChildLinkageStatus GetChildLinkageStatusVal(string S)
		{
		...
		public static string GetChildLinkageStatusStr(TGEDCOMChildLinkageStatus val)
		{
			string S;
			switch (val) {
		...
		public static TCommunicationType GetCommunicationTypeVal(string S)
		{
		...
		public static TGEDCOMMultimediaFormat GetMultimediaFormatVal(string S)
		{
		...
		public static TGEDCOMMediaType GetMediaTypeVal(string S)
		{
		...
		public static TGEDCOMNameType GetNameTypeVal(string S)
		{
		...
		public static TResearchStatus GetStatusVal(string S)
		{
		...
		public static TGEDCOMSpouseSealingDateStatus GetSpouseSealingDateStatusVal(string S)
		{
		...
		public static TGEDCOMOrdinanceProcessFlag GetOrdinanceProcessFlagVal(string S)
		{
		...
		public static string GetPriorityStr(TResearchPriority val)
		{
			string S = "";
			switch (val)
			{
		...
		public static TResearchPriority GetPriorityVal(string S)
		{
		...
		public static TGEDCOMCharacterSet GetCharacterSetVal(string S)
		{
		...
		public static TGEDCOMSex GetSexVal(string S)
		{
			TGEDCOMSex Result;
