...
type
  ...
  TSetOfAttribute = set of TCellAttribute;
  ...
  protected
    ...
    procedure SetAttribute(Value: TSetOfAttribute);
  public
    Col, Row: Word;
    ...
    property Attribute: TSetOfAttribute write SetAttribute;
  end;
  ...
  private
    ...
    function AddCell(vCol, vRow: Word; vAttribute: TSetOfAttribute; CellRef: TCellClass): TCell;
  ...
  public
    ...
    procedure AddWordCell(vCol, vRow: Word; vAttribute: TSetOfAttribute; aValue: Word);
    procedure AddIntegerCell(vCol, vRow: Word; vAttribute: TSetOfAttribute; aValue: Integer);
    procedure AddDoubleCell(vCol, vRow: Word; vAttribute: TSetOfAttribute; aValue: Double);
    procedure AddStrCell(vCol, vRow: Word; vAttribute: TSetOfAttribute; aValue: string);
    procedure Clear;
...
procedure TBIFFWriter.WriteSingleStr(s: string);
begin
  Stream.Write(s[1], Length(s));
end;

procedure TBIFFWriter.WriteStr(s: string);
var
   panjang: Integer;
begin
  panjang := Length(s);
...
function TXLSFile.AddCell(vCol, vRow: Word; vAttribute: TSetOfAttribute; CellRef: TCellClass): TCell;
var
  C: TCell;
begin
  C := CellRef.Create;
...
procedure TXLSFile.AddWordCell(vCol, vRow: word; vAttribute: TSetOfAttribute; aValue: Word);
begin
  with TWordCell(AddCell(vCol, vRow, vAttribute, TWordCell)) do Value := aValue;
end;

procedure TXLSFile.AddIntegerCell(vCol, vRow: Word; vAttribute: TSetOfAttribute; aValue: Integer);
begin
  with TIntegerCell(AddCell(vCol, vRow, vAttribute, TIntegerCell)) do Value := aValue;
end;

procedure TXLSFile.AddDoubleCell(vCol, vRow: Word; vAttribute: TSetOfAttribute; aValue: Double);
begin
  with TDoubleCell(AddCell(vCol, vRow, vAttribute, TDoubleCell)) do Value := aValue;
end;

procedure TXLSFile.AddStrCell(vCol, vRow: Word; vAttribute: TSetOfAttribute; aValue: string);
begin
...
procedure TCell.SetAttribute(Value: TSetOfAttribute);
var
  i: Integer;
begin
  //reset
