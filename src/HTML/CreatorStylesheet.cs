    ...
    public class CreatorStylesheet : Creator
    {
        ...
        public void Create()
        {
            ...
            try {
                ...
                fs = new FileStream(string.Concat(CConfig.Instance.OutputFolder, "\\", CConfig.Instance.StylesheetFilename, ".css"), FileMode.Create);
                ...
                if (CConfig.Instance.AllowMultipleImages) {
                    ...
                    int nMainWidth = (760 - (int)CConfig.Instance.MaxImageWidth);
                    if (nMainWidth < 0) {
                        nMainWidth = 600;
                    }
