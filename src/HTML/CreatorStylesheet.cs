    ...
    public class CreatorStylesheet : Creator
    {
        ...
        public void Create()
        {
            ...
            try {
                ...
                fs = new FileStream(String.Concat(MainForm.Config.OutputFolder, "\\", MainForm.Config.StylesheetFilename, ".css"), FileMode.Create);
                sw = new StreamWriter(fs);

                sw.WriteLine(String.Concat("/* CSS file generated by ", MainForm.SoftwareName, " on ", date, " */"));
                sw.WriteLine("BODY {");
                ...
                if (MainForm.Config.AllowMultipleImages) {
                    ...
                    int nMainWidth = (760 - (int)MainForm.Config.MaxImageWidth);
                    if (nMainWidth < 0) {
                        nMainWidth = 600;
                    }
                ...
                sw.WriteLine("  width:" + (MainForm.Config.MaxImageWidth + 2) + "px;");
                sw.WriteLine("  height:" + (MainForm.Config.MaxImageHeight + 40) + "px;");
                ...
                sw.WriteLine("  width:" + (MainForm.Config.MaxThumbnailImageWidth + 3) + "px;");
                sw.WriteLine("  height:" + (MainForm.Config.MaxThumbnailImageHeight + 3) + "px;");
                sw.WriteLine("  text-align:center;");
                sw.WriteLine("}");
