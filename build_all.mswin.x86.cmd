...
%MSBDIR%\msbuild.exe projects\GEDKeeper2.mswin.sln /p:Configuration=%CONFIG_TYPE% /p:Platform="x86" /t:Rebuild /p:TargetFrameworkVersion=v4.6.2
...
%NUNIT% projects\GKTests\bin\Debug\GKTests.dll --framework=v4.6.2
pause 
exit /b 0
