...
namespace GEDmill.HTML
{
    ...
    public class CreatorStylesheet : Creator
    {
        ...
        public CreatorStylesheet(IBaseContext context, IProgressCallback progress, ILangMan langMan, string cssFilename, string backgroundImageFilename) : base(context, progress, langMan)
        {
        ...
        public void Create()
        {
            fLogger.WriteInfo("CreatorStylesheet::Create()");
            ...
            try {
                ...
                var fs = new FileStream(string.Concat(GMConfig.Instance.OutputFolder, "\\", GMConfig.StylesheetFilename), FileMode.Create, FileAccess.Write);
