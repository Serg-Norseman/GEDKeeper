...
namespace Sandbox1
{
    ...
    public static class RusDeclensionOld
    {
        /// <summary>
        ...
        private static string _declension(string word, int declCase /*=2*/, string gender /* = "*" */, int part /* =0 */)
        {
            ...
            if (z5 == 0) {
                ...
                z6 = "-" + _declension(Mid(word, z5 + 1, word.Length - z5 + 1), declCase, gender, part);
            }

            word = LCase(z5 == 0 ? word : Left(word, z5 - 1));
            ...
            int ze = InStr("лец нёк вей бей дец пец мец нец рец вец аец иец ыец бер", z7);
            ...
            if (zd == 8 && _dc != DeclensionCase.Instrumental) {
                ...
                if (InStr("аеёийоуыэюя", Mid(word, z5 - 3, 1)) == 0 && (zb > 11 || zb == 0) && (ze != 49)) res = "";
                else if (za == 7) res = "л";
                else if (za == 10) res = "к";
            ...
            if (zd == 9 || ((part == 3) && (Right(word, 1) == "ы"))) {
                ...
                string template = "а у а " + ((z8 == "ич") || (z8 == "ыш") ? "е" : ((z8 == "ов") || (z8 == "ин") ? "ы" : "о")) + "ме " + (InStr("гжкхш", Left(z8, 1)) > 0 ? "и" : "ы") + " е у " + (z8 == "ца" ? "е" : "о") + "йе я ю я ем" + (za == 16 ? "и" : "е") + " и е ю ейе и и ь ьюи и и ю ейи ойойу ойойойойуюойойгомуго" + ((res == "е") || (za == 16) || ((zb > 12) && (zb < 16)) ? "и" : "ы") + "мм";
