...
{
    public sealed class PersonParentsAttach : CustomOperation
    {
        private string fPersonXRef;
        private string fFamilyXRef;

        public PersonParentsAttach(UndoManager manager, GEDCOMIndividualRecord person, GEDCOMFamilyRecord family) : base(manager)
        {
