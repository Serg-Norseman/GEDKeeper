...
namespace GKCore.Operations
{
    ...
    /// 
    /// </summary>
    public sealed class GroupMemberDetach : CustomOperation
    {
        private string fGroupXRef;
        private string fMemberXRef;

        public GroupMemberDetach(UndoManager manager, GEDCOMGroupRecord group, GEDCOMIndividualRecord member) : base(manager)
        {
