...
namespace GKUI.Forms
{
    public partial class PersonsFilterDlg : CommonFilterDlg, IPersonsFilterDlg
    {
        ...
        private void rgLife_CheckedChanged(object sender, ToggledEventArgs e)
        {
        ...
        private void cmbFilter_KeyUp(object sender, KeyEventEventArgs e)
        {
            if (e.KeyEvent.Key == Key.Delete && e.KeyEvent.IsCtrl) {
