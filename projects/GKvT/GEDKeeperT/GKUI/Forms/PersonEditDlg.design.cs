...
namespace GKUI.Forms
{
    partial class PersonEditDlg
    {
        ...
        private TabView.Tab pageSpouses;
        private TabView.Tab pageAssociations;
        ...
        private TabView.Tab pageNames;
        private TextField txtMarriedSurname;
        private Label lblMarriedSurname;
        private TabView.Tab pageParents;
        private TabView.Tab pageChilds;
        private TabView.Tab pageDNATests;
        private TabView.Tab pageFamily;
        ...
        private void InitializeComponent()
        {
            ...
            pageFamily = new TabView.Tab();
            tabsFamily = new TabView();
            pageSpouses = new TabView.Tab();
            pageParents = new TabView.Tab();
            pageChilds = new TabView.Tab();
            pageAssociations = new TabView.Tab();
            pageNames = new TabView.Tab();
