...
namespace GKUI.Platform
{
    ...
    public sealed class ComboBoxHandler : BaseControlHandler<AutoCompleteBox, ComboBoxHandler>, IComboBox
    {
        private IList fItems;

        public ComboBoxHandler(AutoCompleteBox control) : base(control)
        {
            fItems = new List<object>();
            control.Items = fItems;
        ...
        {
            get { return /*Control.SelectedIndex*/ 0; }
