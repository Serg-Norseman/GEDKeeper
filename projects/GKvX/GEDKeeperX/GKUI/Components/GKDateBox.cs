...
namespace GKUI.Components
{
    ...
    /// 
    /// </summary>
    public class GKDateBox : ContentView
    {
        ...
        {
            get { return btnPopup.IsVisible; }
            set { btnPopup.IsVisible = value; }
        }*/
        ...
        {
            get { return txtMaskedDate.IsReadOnly; }
            set {
                //btnPopup.IsEnabled = !value;
                txtMaskedDate.IsReadOnly = value;
            }
        }
        ...
        {
            get { return /*txtMaskedDate.SelectedText*/ string.Empty; }
        ...
        {
            add {
                txtMaskedDate.TextChanged += new EventHandler<TextChangedEventArgs>(value);
            }
            remove {
                txtMaskedDate.TextChanged -= new EventHandler<TextChangedEventArgs>(value);
            }
        ...
        public GKDateBox()
        {
            ...
            txtMaskedDate.Behaviors.Add(new MaskedBehavior() { Mask = mask, UnMaskedCharacter = '0' });
            txtMaskedDate.Placeholder = fRegionalDatePattern;
        }
        ...
        private Entry txtMaskedDate; // MaskedTextBox
        ...
        private void InitializeComponent()
        {
            ...
            txtMaskedDate = new Entry(); //MaskedTextBox();
            txtMaskedDate.Keyboard = Keyboard.Numeric;

            /*txtMaskedDate.SizeChanged += (object sender, EventArgs e) => {
                btnPopup.Height = txtMaskedDate.Height;
            };*/

            Content = txtMaskedDate;/*new StackLayout() {
