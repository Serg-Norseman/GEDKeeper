...
namespace GEDmill
{
    ...
    public enum PLS
    {
        ...
        LSID_ConfigUserRefInIndex_unused,
        ...
        LSID_ConfigKeepSiblingOrder_unused,
        LSID_MiniTreeColors,
        LSID_ConfigMiniTreeColorIndiHighlight,
        LSID_ConfigMiniTreeColorIndiText,
        LSID_ConfigMiniTreeColorIndiBackground,
        LSID_ConfigMiniTreeColorIndiLink,
        LSID_ConfigMiniTreeColorIndiBgConcealed,
        LSID_ConfigMiniTreeColorIndiFgConcealed,
        LSID_ConfigMiniTreeColorIndiShade,
        LSID_ConfigMiniTreeColorBranch,
        LSID_ConfigMiniTreeColorIndiBorder,
        LSID_ConfigUserRecFilename_unused,
