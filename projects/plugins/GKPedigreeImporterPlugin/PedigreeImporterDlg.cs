    ...
    public sealed partial class PedigreeImporterDlg : CommonForm
    {
        ...
        public PedigreeImporterDlg(IPlugin plugin, IBaseWindow curBase)
        {
            ...
            cbGenerationFormat.Items.AddRange(new object[] {
                                                  "I, II, III, IV...",
                                                  fLangMan.LS(PLS.Generation) + " N"});

            cbNameFormat.Items.AddRange(new object[] { fLangMan.LS(PLS.NPS), fLangMan.LS(PLS.SNP) });

            cbPersonSeparator.Items.AddRange(new object[] { fLangMan.LS(PLS.NoSpecial), ";", "," });
            ...
            // SetLocale()
            Text = fLangMan.LS(PLS.PedigreeImporter);
        ...
        private async void btnImportFileChoose_Click(object sender, EventArgs e)
        {
            ...
            try {
                ...
                MessageBox.Show(ex.Message, fLangMan.LS(PLS.PedigreeImporter), MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
