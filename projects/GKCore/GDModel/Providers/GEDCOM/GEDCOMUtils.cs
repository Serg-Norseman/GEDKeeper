...
namespace GDModel.Providers.GEDCOM
{
    ...
    public static class GEDCOMUtils
    {
        ...
        /// <summary>
        /// Implementation without a delegate is 60-67% faster.
        /// </summary>
        ...
        /// <summary>
        /// This implementation is 30-35% faster than the old set of direct conditions.
        /// </summary>
        public static GDMMultimediaFormat GetMultimediaFormatVal(string str)
        {
            ...
            int idx = BinarySearch(GEDCOMConsts.MultimediaFormatValues, str.Trim());
            GDMMultimediaFormat result = (idx >= 0) ? (GDMMultimediaFormat)idx : GDMMultimediaFormat.mfUnknown;
            return result;
        }
