...
namespace GKCore.MapiMail
{
    ...
    public class RecipientCollection : CollectionBase
    {
        ...
        /// </summary>
        public void Add(string address, string displayName = null, MapiMailMessage.RecipientType recipientType = MapiMailMessage.RecipientType.To)
        {
    ...
    internal static class NativeMethods
    {
        ...
        internal static string MAPIErrorText(int errorCode)
        {
