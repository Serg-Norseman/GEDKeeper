    ...
    public sealed class PersonEditDlgController : DialogController<IPersonEditDlg>
    {
        ...
        public void UpdateNameControls(GDMPersonalName np)
        {
            ...
            if (np != null) {
                ...
                fView.Nickname.Text = np.Pieces_Nickname;
                fView.SurnamePrefix.Text = np.Pieces_SurnamePrefix;
                fView.NameSuffix.Text = np.Pieces_Suffix;
