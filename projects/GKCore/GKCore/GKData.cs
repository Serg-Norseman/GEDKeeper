...
namespace GKCore
{
    ...
    public static class GKData
    {
        ...
        public const string APP_COPYRIGHT = "Copyright © 2009-2026 by Sergey V. Zhdanovskih";

        public const string APP_VERSION_2X = "2.38.0.0";
        public const string APP_VERSION_3X = "3.14.0.0";
