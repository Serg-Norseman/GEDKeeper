...
using GKCortex.Services;

namespace GKCortex.Tools;
...
internal class CreateGenealogyTaskTool : BaseTool
{
    ...
    public override List<MCPContent> ExecuteTool(BaseContext baseContext, JsonElement args)
    {
        ...
        var service = new MemoryService();
        int newId = service.CreateTask(targetPerson, goalDescription);
...
internal class UpdateTaskProgressTool : BaseTool
{
    ...
    public override List<MCPContent> ExecuteTool(BaseContext baseContext, JsonElement args)
    {
        ...
        var service = new MemoryService();
        bool success = service.UpdateTaskProgress(taskId, addCheckedSource, setNextSteps);
